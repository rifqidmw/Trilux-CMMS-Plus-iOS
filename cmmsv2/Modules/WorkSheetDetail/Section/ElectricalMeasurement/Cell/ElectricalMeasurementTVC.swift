...
extension ElectricalMeasurementTVC {
    ...
    func setupCell(data: ElectricalMeasurementModel) {
        ...
        containerStackView.addBorder(width: 1, colorBorder: valueCondition ? UIColor.customIndicatorColor10 : UIColor.customIndicatorColor4)
        ...
        containerValueView.addBorder(width: 1, colorBorder: valueCondition ? UIColor.customIndicatorColor10 : UIColor.customIndicatorColor3)
        containerValueView.addBorder(width: 1, colorBorder: valueCondition ? UIColor.customIndicatorColor10 : UIColor.customIndicatorColor4)
    }
