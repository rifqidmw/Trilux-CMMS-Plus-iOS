...
class CalibrationCVC: UICollectionViewCell {
    
    static let identifier = String(describing: CalibrationCVC.self)
    static let nib = {
    ...
    override func awakeFromNib() {
        ...
        self.correctionView.makeCornerRadius(4)
        self.statusView.makeCornerRadius(4)
    }
    
}

extension CalibrationCVC {
    
    func setupCell(data: CalibrationListEntity) {
        uniqueNumberLabel.text = data.uniqueNumber
        correctionView.isHidden = !data.correctionStatus
